...
const ASSETS = ["./", "./index.html", "./style.css?v=17", "./app.js?v=17", "./qr.js?v=17", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
