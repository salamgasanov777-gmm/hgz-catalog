...
const ASSETS = ["./", "./index.html", "./style.css?v=22", "./app.js?v=22", "./qr.js?v=22", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
