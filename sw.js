...
const ASSETS = ["./", "./index.html", "./style.css?v=21", "./app.js?v=21", "./qr.js?v=21", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
