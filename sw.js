...
const ASSETS = ["./", "./index.html", "./style.css?v=19", "./app.js?v=19", "./qr.js?v=19", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
