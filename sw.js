...
const ASSETS = ["./", "./index.html", "./style.css?v=24", "./app.js?v=24", "./qr.js?v=24", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
