...
const ASSETS = ["./", "./index.html", "./style.css?v=15", "./app.js?v=15", "./qr.js?v=15", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
