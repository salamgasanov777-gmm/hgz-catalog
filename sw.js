...
const ASSETS = ["./", "./index.html", "./style.css?v=18", "./app.js?v=18", "./qr.js?v=18", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
