...
const ASSETS = ["./", "./index.html", "./style.css?v=29", "./app.js?v=29", "./qr.js?v=29", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
