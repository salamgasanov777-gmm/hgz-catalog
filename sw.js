...
const ASSETS = ["./", "./index.html", "./style.css?v=32", "./app.js?v=32", "./qr.js?v=32", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
