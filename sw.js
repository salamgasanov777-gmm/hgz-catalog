...
const ASSETS = ["./", "./index.html", "./style.css?v=31", "./app.js?v=31", "./qr.js?v=31", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
