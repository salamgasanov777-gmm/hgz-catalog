...
const ASSETS = ["./", "./index.html", "./style.css?v=34", "./app.js?v=34", "./qr.js?v=34", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
