...
const ASSETS = ["./", "./index.html", "./style.css?v=26", "./app.js?v=26", "./qr.js?v=26", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
