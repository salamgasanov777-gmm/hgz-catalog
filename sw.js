...
const ASSETS = ["./", "./index.html", "./style.css?v=27", "./app.js?v=27", "./qr.js?v=27", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
