...
const ASSETS = ["./", "./index.html", "./style.css?v=14", "./app.js?v=14", "./qr.js?v=14", "./products.json", "./content.json", "./manifest.json", "./icon-192-v2.png", "./icon-512-v2.png"];
